...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.x"
  WORKING_DIRECTORY "/home/clark/Cinder/my-projects/final-project-Beijingsheng/cmake-build-debug/_deps/catch2-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v2.x" tag_sha error_msg)
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/clark/Cinder/my-projects/final-project-Beijingsheng/cmake-build-debug/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/clark/Cinder/my-projects/final-project-Beijingsheng/cmake-build-debug/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
